...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-block">
                    <center class="m-t-30"> <img src="assets/images/users/5.jpg" class="img-circle" width="150"  alt="管理员"/>
                        <h4 class="card-title m-t-10" style="padding-top:5px"><s:property value="#adm.a_name"/></h4>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-block">
                    <form class="form-horizontal form-material" action="EditPersonalData.jsp" method="post">
                        ...
                        <div class="form-group">
                            <label class="col-md-12">身份</label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 text-center">
                                <button class="btn btn-success">编辑个人资料</button>
                            </div>
                        </div>
                    </form>
                </div>
