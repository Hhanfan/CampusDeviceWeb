                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <s:iterator value="#session.borrows" var="b">
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confirmReturn">确认归还</button>
                                            </td>
                                        </tr>
                                    </s:iterator>
                                    </tbody>
                                ...
                                <!--确认归还模态框-->
                                <div class="modal fade" id="confirmReturn" tabindex="-1" role="dialog" aria-labelledby="confirmReturnTitle" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <a href="returned.action"><span aria-hidden="true">×</span></a>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                ...
                                                <s:form action="return" method="POST" role="form" theme="simple" class="hero-form">
                                                    <div style="margin-left: 20px">
                                                        ...
                                                        <div>
                                                            <label>
                                                                <input type="radio" name="returnDevice.rd_deviceState" id="optionsRadios2" value="damage" style="margin-right: 5px" />
                                                                损坏
                                                            </label>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="subimt" class="btn btn-primary" data-target="#returnSuccess">确认归还</button>
                                                    </div>
                                                </s:form>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <button type="submit" class="close" aria-label="Close">
                                                    <span aria-hidden="true"><a href="returned.action">×</a></span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <p>归还成功！</p>
