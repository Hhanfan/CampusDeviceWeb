...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <!-- Column -->
                <div class="col-lg-10 col-xlg-30 col-md-5">
                    <div class="card">
                        <div class="card-block">
                            <!--修改密码-->
                            <form action="editName" method="post" enctype="multipart/form-data" class="form-horizontal form-material">
                                <div class="form-group">
                                    <h4 class="text-themecolor m-b-0 m-t-0">修改姓名：</h4>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">请输入新的姓名（20个字符以内）：</label>
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control form-control-line" name="newName">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
