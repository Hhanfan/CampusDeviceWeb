...
<section class="hero-section">
    ...
    <!--注册失败提示模态框-->
    <div class="modal fade" id="loginFailure" tabindex="-1" role="dialog" aria-labelledby="inputSuccessTitle" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" aria-label="Close">
                        <span aria-hidden="true"><a href="login.jsp">×</a></span>
                    </button>
                </div>
