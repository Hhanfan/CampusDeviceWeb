                            ...
                            <div class="modal-body" style="margin-bottom: -35px">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-append date form_date col-md-12" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                        <input class="form-control col-md-12" type="date" name="device.d_storeDate" value="点击选择日期">
                                            ...
                                            <tr>
                                                <td>
                                                    <input name="checkbox" type="checkbox"
                                                           value="<s:property value="#d.d_no"/>" style="display: none;width: 18px;height: 18px">
                                                </td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="close" aria-label="Close">
                                <span aria-hidden="true"><a href="device.action?page=<%=pages%>">×</a> </span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p>设备录入成功！</p>
