                ...
                <div class="col-lg-6 col-xlg-7 col-md-5">
                    <div class="card">
                        <div class="card-block">
                            <!--修改密码-->
                            <form action="editPersonalData" method="post" enctype="multipart/form-data" class="form-horizontal form-material">
                                <div class="form-group">
                                    <h4 class="text-themecolor m-b-0 m-t-0">更换手机号：</h4>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">请输入旧的手机号码：</label>
                                    <div class="col-md-12">
                                        <input type="password" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">请输入新的手机号码：</label>
                                    <div class="col-md-12">
                                        <input type="password" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-lg-6">
                                            <button class="btn btn-success">获取验证码</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
