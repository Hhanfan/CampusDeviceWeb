    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="margin-left:0;margin-bottom: 10px">
                ...
                <button  type="button" class="btn btn-info" data-toggle="modal" data-target="#inputDevice" style="margin-right: 5px">批量导入</button>
                <button id="edit" type="button" class="btn btn-info">编辑</button>
                <button button id="modifyD" type="button" class="btn btn-info" style="margin-left: 620px;display: none" data-toggle="modal" data-target="#modifyDevice">修改设备</button>
                            ...
                            <div class="modal-body" style="margin-bottom: -15px">
                                ...
                                <div class="form-group" style="margin-bottom: 5px">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" data-inline="true" class="iCalendar form-control date form_date" name="device.d_storeDate"
...
<%--                                </div>--%>
                            ...
                            <div class="modal-footer">
                                ...
                                <s:submit type="button" class="btn btn-success">确认录入</s:submit>
                            </div>
                        </s:form>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <input name="checkbox" type="checkbox"
                                                       value="<s:property value="#d.d_no"/>" style="visibility: hidden;width: 18px;height: 18px">
                                            </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="button" value="delete" class="btn btn-success">确认删除</button>
                            </div>
                        </div>
                    </div>
                </div>
