        ...
        <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="">
                    <p style="font-size:20px;margin-top:10px;">校园实验设备管理系统</p>
                </a>
            </div>
            <!-- ============================================================== -->
            <!-- End Logo -->
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">编辑个人资料</h3>
                </div>
            </div>
            <!-- ============================================================== -->
                ...
                <div class="col-lg-6 col-xlg-7 col-md-5">
                    <div class="card">
                        <div class="card-block">
                            <!--修改密码-->
                            <form id="form" action="" class="form-horizontal form-material" method="post">
                                <div class="form-group">
                                    <h4 class="text-themecolor m-b-0 m-t-0">修改密码：</h4>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">请输入旧密码：</label>
                                    <div class="col-md-12">
                                        <input type="password" value="<s:property value="#session.oldPassword"/>" class="form-control form-control-line" id="oldPassword" name="oldPassword" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">请输入新密码：</label>
                                    <div class="col-md-12">
                                        <input type="password" value="<s:property value="#session.newPassword"/>" class="form-control form-control-line" id="newPassword" name="newPassword"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">请再次输入新密码：</label>
                                    <div class="col-md-12">
                                        <input type="password" value="<s:property value="#session.secondPassword"/>" class="form-control form-control-line" id="secondPassword" name="secondPassword"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">请输入验证码：</label>
                                    <div class="row col-md-12">
                                        <div class="col-lg-6">
                                            <input type="text" value="<s:property value="#session.verifyCode"/>" class="form-control form-control-line" name="verifyCode"/>
                                        </div>
                                        <div class="col-lg-6">
                                            <button id="sendMessage" name="sendMessage" class="btn btn-success">获取验证码</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button id="changePassword" name="changePassword" class="btn btn-success">确认修改</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script>
    ...
    $("#changePassword").click(function(){
        ...
        document.getElementById("secondPassword").value=$.md5(document.getElementById("secondPassword").value);
