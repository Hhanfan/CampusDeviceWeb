                        ...
                        <div class="card-block">
                            ...
                            <form id="form" action="" class="form-horizontal form-material" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="password" class="form-control form-control-line" id="oldPassword" name="oldPassword"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">请输入新密码：</label>
                                    <div class="col-md-12">
                                        <input type="password" class="form-control form-control-line" id="newPassword" name="newPassword"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">请再次输入新密码：</label>
                                    <div class="col-md-12">
                                        <input type="password" class="form-control form-control-line" id="secondPassword" name="secondPassword"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row col-md-12">
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control form-control-line" name="verifyCode"/>
                                        </div>
                                        <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button id="changePassword" class="btn btn-success">确认修改</button>
                                    </div>
                                </div>
                            </form>
                        </div>
