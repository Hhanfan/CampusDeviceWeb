                                ...
                                <table class="table table-hover">
                                    ...
                                    <s:iterator value="#session.rsrvlist" var="rl">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#<%=y%>">拒绝</button>
                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#<%=x%>">同意</button>
                                                <button type="button" class="btn btn-custom" data-toggle="modal" data-target="#<%=z%>">调整时间</button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="<%=z%>" tabindex="-1" role="dialog" aria-labelledby="modifyTimeTitle" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <s:form theme="simple" method="POST" action="editrsrv" role="form">
                                                        <s:hidden name="r_no" value="%{#rl.r_no}"/>
                                                        <div class="modal-body" style="margin-bottom: -20px">
                                                            <div class="form-group">
                                                                <label class="col-md-12">调整时间理由</label>
                                                                <div class="col-md-12">
                                                                    <textarea class="form-control" name="feedBack" rows="5" placeholder="请输入调整时间的具体理由"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="text" data-inline="true" class="iCalendar form-control date form_date" name="startDate"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="text" data-inline="true" class="iCalendar form-control date form_date" name="endDate"
                                                                           data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                                                </div>
                                                            </div>
                                                        </div>
